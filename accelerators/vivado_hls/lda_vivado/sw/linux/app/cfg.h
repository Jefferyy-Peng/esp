...
const int32_t windows = WINDOWS;
const int32_t Test_epochs = TEST_EPOCHS;
const int32_t Tol = TOL;

#define NACC 1

struct lda_vivado_access lda_cfg_000[] = {
	{
		/* <<--descriptor-->> */
...
esp_thread_info_t cfg_000[] = {
	{
		.run = true,
		.devname = "lda_vivado.0",
		.ioctl_req = LDA_VIVADO_IOC_ACCESS,
		.esp_desc = &(lda_cfg_000[0].esp),
	}
};
